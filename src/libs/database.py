...
class Database:
    ...
    def create_table(self, tabela, campos, complemento=""):
        if complemento:
    ...
    def update(self, tabela, sets, id_):
    ...
    def save(self, tabela, campos, valores):
