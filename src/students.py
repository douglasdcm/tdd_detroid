...
class Students:
    ...
    def lanca_nota(self, aluno_id: int, materia_id: int, nota: float):
        assert isinstance(aluno_id, int), "aluno_id must be an integer"
        assert isinstance(aluno_id, int), "materia_id must be an integer"
        assert isinstance(aluno_id, float), "materia_id must be a float"
    ...
    def inscreve_materia(self, aluno_id: int, materia_id: int):
        assert isinstance(aluno_id, int), "aluno_id must be an integer"
        assert isinstance(aluno_id, int), "materia_id must be an integer"
        aluno = AlunoModelo(self._conn)
        aluno.id = aluno_id
