...
class TestAluno:
    ...
    def test_should_status_return_to_previous_when_student_unlocked(
        self, inscreve_aluno
    ):
    ...
    def test_aluno_trancado_quando_calcula_situacao_retorna_trancado(
        self, inscreve_aluno
    ):
    ...
    def test_nota_minima_aluno_deve_ser_zero(self, inscreve_aluno):
        ...
        with raises(
            Exception, match="Nota mínima do aluno não pode ser menor do que 0."
        ):
            aluno.atualiza_materias_cursadas(materias)
    ...
    def test_nota_maxima_aluno_deve_ser_dez(self, inscreve_aluno):
        ...
        aluno, _ = inscreve_aluno
        with raises(
            Exception, match="Nota máxima do aluno não pode ser maior do que 10."
        ):
            aluno.atualiza_materias_cursadas(materias)
    ...
    def test_aluno_aprovado_em_segunda_tentativa_entao_nova_nota_entra_no_cr(
        self, inscreve_aluno
    ):
        expected = 8
    ...
    def test_aluno_com_cr_maior_que_sete_ao_fim_do_curso_esta_aprovado(
        self, inscreve_aluno
    ):
        expected = Situacao.aprovado.value
        materias = {materia_nome_1: 8, materia_nome_2: 8, materia_nome_3: 8}
    ...
    def test_aluno_cursou_uma_materia_tem_coeficiente_rendimento_igual_nota(
        self, inscreve_aluno
    ):
        expected = 7
